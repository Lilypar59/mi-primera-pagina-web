...
<body>
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			<a class="navbar-brand" href="https://www.configuroweb.com/desarrollo/">ConfiguroWeb - Ejemplo de prueba</a>
		</div>
	</nav>
	<div class="col-md-3"></div>
	<div class="col-md-6 well">
		<h3 class="text-primary">PHP - Cómo exportar a Excel desde PHP - Ejemplo de prueba
		</h3>
